...
<aside class="sidebar">
    ...
    <nav>
        <a href="index.php" class="nav-link <?= $activePage === 'dashboard' ? 'active' : '' ?>">
            ...
            <span class="nav-text-full">Dashboard</span>
            <span class="nav-text-short">Dashboard</span>
        </a>
        <a href="input.php" class="nav-link <?= $activePage === 'input' ? 'active' : '' ?>">
            ...
            <span class="nav-text-full">Input Transaksi TPS</span>
            <span class="nav-text-short">Input</span>
        </a>
        <a href="settings.php" class="nav-link <?= $activePage === 'settings' ? 'active' : '' ?>">
            ...
            <span class="nav-text-full">Pengaturan</span>
            <span class="nav-text-short">Settings</span>
        </a>
        <button type="button" id="btn-open-reset" class="nav-link nav-link--danger">
            ...
            <span class="nav-text-full">Reset Data</span>
            <span class="nav-text-short">Reset</span>
        </button>
    </nav>
